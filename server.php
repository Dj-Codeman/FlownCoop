...
$db = mysqli_connect('127.0.0.1', 'admin', 'Danny9518!', 'Nest');
...
//  if (empty($sid)) { array_push($errors, "Student id is required"); }
  if (empty($advisory)) { array_push($errors, "Please enter your advisory number"); }
...
if(isset($_POST['Flag_Events'])){
 ...
 if(isset($_POST['Delete_Events'])){
	...
	if ($opp == "add") { $operation = "Insert INTO Nest.adv_list (adv_num) VALUES('$num')"; }
	if ($opp == "remove") {
