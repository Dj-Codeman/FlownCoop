...
<body>
  ...
  <div class="header" style="border-bottom: 8px solid #f2e711;">
    ...
    <div class="input-group-top">
      <button type="button" class="btn-home <?php if (" $site"=="index" ) { ?> current
        <?php
}?>" name="home_page"><a href="index.php">HOME</a>
      </button>
      <button type="button" class="btn-home <?php if (" $site"=="events" ) { ?> current
        <?php
}?>" name="events_page"><a href="events.php">EVENTS</a>
      </button>
      <button type="button" class="btn-home <?php if (" $site"=="logform" ) { ?> current
        <?php
}?>" name="log_page"><a href="logform.php">LOG YOUR WORK</a>
      </button>
      <button type="button" class="btn-home <?php if (" $site"=="Log" ) { ?> current
        <?php
}?>" name="List_page"><a href="Log.php">YOUR LOG</a>
      </button>
      <button type="button" class="btn-home <?php if (" $site"=="activity" ) { ?> current
        <?php
}?>" name="List_page"><a href="Log.php">ACTIVITY</a>
      </button>
